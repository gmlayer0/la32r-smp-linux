...
#define LOONGSON_UART_IRQ		(LOONGSON_CPU_IRQ_BASE + 3) /* IP2 for CPU local interrupt controller */
#define LOONGSON_GMAC_IRQ		(LOONGSON_CPU_IRQ_BASE + 2) /* IP3 for bridge */
